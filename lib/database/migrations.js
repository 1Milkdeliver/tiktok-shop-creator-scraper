...
const MIGRATIONS = [
  ...
  {
    version: 2,
    name: 'creator_activity_classification',
    sql: `
      ALTER TABLE creators ADD COLUMN last_publish_at TEXT;
      ALTER TABLE creators ADD COLUMN activity_status TEXT NOT NULL DEFAULT 'unknown';
      ALTER TABLE creators ADD COLUMN activity_reason TEXT NOT NULL DEFAULT 'insufficient_data';
      CREATE INDEX IF NOT EXISTS idx_creators_activity ON creators(activity_status);
    `,
  },
  {
    version: 3,
    name: 'creator_vertical_category',
    sql: `
      ALTER TABLE creators ADD COLUMN vertical_category TEXT;
      CREATE INDEX IF NOT EXISTS idx_creators_vertical ON creators(vertical_category);
    `,
  },
];
