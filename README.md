...
6. 点 **▶ 开始抓取** —— 下方日志区实时显示进度（可随时暂停 / 继续 / 一键结束并立即导出）
7. 完成后文件保存到你选的文件夹：`达人数据-日期-时间.csv` / `.xlsx`
...
- 支持按 昵称/粉丝数/GMV/销量/活跃度 等排序、筛选（活跃 / 不活跃 / 未知）
- **活跃度**：工具根据最近发布时间、增长趋势、GMV 变化自动判断达人当前是否活跃，帮你在谈合作前快速筛掉"僵尸达人"
- 点 **刷新** 可重新抓取最新数据并更新库（带进度条 + 预计剩余时间）
